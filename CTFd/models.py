...
class Challenges(db.Model):
    ...
    def __init__(self, name, description, value, category, type='standard', penalty=0):
        self.name = name
...
class Files(db.Model):
    ...
    def __init__(self, chal, location, dynamic=False):
        self.chal = chal
...
class Teams(db.Model):
    ...
    def __init__(self, name, email, password):
        ...
        self.token = utils.sha512(os.urandom(10))
...
class CheatPenalty(db.Model):
    ...
    date = db.Column(db.DateTime, default=datetime.datetime.utcnow)
    flag = db.Column(db.Text)
    chal = db.relationship('Challenges', foreign_keys="CheatPenalty.chalid", lazy='joined')
    penalty = db.Column(db.Integer)

    def __init__(self, teamid, chalid, ip, flag, penalty):
        self.ip = ip
        self.teamid = teamid
        self.chalid = chalid
        self.flag = flag
    ...
    def __repr__(self):
        return '<cheatpenalty {}, {}, {}, {}, {}>'.format(self.teamid, self.chalid, self.ip, self.flag, self.penalty)
